...
Moran scatter plot for `emigrates`. The countries with important spatial autocorrelation in HH cluster are Venezuela, Western Samoa, Moldova, among others. The Moran I test indicates significant positive spatial autocorrelation.
...
Moran scatter plot for `immigrates`. The Moran I test indicates significant positive spatial autocorrelation.
